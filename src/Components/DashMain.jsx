            ...
            <div className='flex gap-[1rem] h-[35%]'>
                <div className='bg-white rounded-3xl flex gap-[1rem] w-3/4 p-4'>
                    <div className='w-[40%] rounded-2xl h-full overflow-hidden border'>
                        <Image src="/images/test-img.png" className="w-full h-full object-cover" alt="Logo" width={1800} height={700} />
                    </div>
                    <div className='border-l p-2 px-5 flex flex-col justify-around'>
                        <div className='text-[1.3rem] flex items-center gap-[.5rem] font-bold '>
                            {curUser.name}
                            <span className='bg-[#1678FB] text-[.7rem] px-3 py-[2px] rounded-full text-white'>Active</span>
                        </div>
                ...
                <div className='bg-white rounded-3xl p-3 w-3/4 flex flex-col gap-[5px]'>
                    <div className='flex justify-between px-4'>
                        ...
                        <div className='flex'>
                            <div className='flex items-center text-[.7rem]'><GoDotFill color='#8884d8' /> Blood Pressure Systolic</div>
                            <div className='flex items-center text-[.7rem]'><GoDotFill color='#55545d' /> Blood Pressure Diastolic</div>
                        </div>
                    </div>
            ...
            <div className='flex gap-[1rem] h-[65%]'>
                <div className={'flex flex-col gap-[1rem] w-[70%]'}>
                    <div className='bg-yellow-300 h-[30%] rounded-3xl relative'>
                        ...
                        <div className='z-20 absolute p-5 flex justify-between w-full items-center'>
                            <div>
                                <div className='font-bold text-[1.5rem]'>Upgrade your account to PRO+</div>
                                <div className='w-[70%]'>with pro+ account you get many additional and convenient features to extra sessions.</div>
                            </div>
                ...
                <div className='bg-white rounded-3xl w-[30%] p-4'>
                    <div className='p-2 pb-4 flex justify-between items-center'>
                        ...
                        <div className='flex'>
                            <select name="" id="" className='text-[#1678FB]' onChange={(e) => setSelectedSession(e.target.value)}>
                                {sessions.map((session, index) => {
                                    return (
                                        <option key={index} value={session}>{session?.title}</option>
                                    )
                                })}
                            </select>
                        </div>
